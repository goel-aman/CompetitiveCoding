...
// where 1≤i≤N/2 (1-indexed). For example, the string CABABC has a goodness score of 2 since S2≠S5 and S3≠S4.
...
// The first line of each test case contains two integers N and K. The second line of 
// each test case contains a string S of length N, consisting of uppercase letters.

// Output
// For each test case, output one line containing Case #x: y, where x is the test case
//  number (starting from 1) and y is the minimum number of operations required to transform
...
int main(){
    ...
    while(t--)
    {
        ...
        ll diff = abs(notequal - k);
        cout<<"Case #"<<m<<": "<<diff<<endl;
        m++;
    }
}