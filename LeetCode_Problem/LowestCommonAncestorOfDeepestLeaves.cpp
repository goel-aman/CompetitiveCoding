...
//  but the depth of them is 2, but the depth of nodes
//  7 and 4 is 3.
...
class Solution {
    ...
    int findHeight(TreeNode* root){
        ...
        int value1 = findHeight(root->left);
