...
// Output: 0
// Explanation: Playing the only token in the bag is 
// impossible because you either 
...
// There is no need to play the 1st token since you cannot
//  play it face up to add to your score.
...
public:
    int bagOfTokensScore(vector<int>& tokens, int P) {
        ...
        int start = 0, end = tokensLength - 1;
        int answer = 0;
        while(start <= end){
