...
// Return True if all the elements in the linked 
// list starting from the head correspond to some 
// downward path connected in the binary tree 
// otherwise return False.
// In this context downward path means a path that 
...
// 1 <= Node.val <= 100 for each node in the linked list and 
// binary tree.
