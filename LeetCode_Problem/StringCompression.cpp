...
// Otherwise, append the character followed by the
//  group's length.
...
// You must write an algorithm that uses only 
...
// should be: ["a","3","b","2","a","2"].
// Explanation: The groups are "aaa", "bb", and "aa". This compresses
//  to "a3b2a2". Note that each group is independent even if two groups
//  have the same character.
 
// Constraints:
// 1 <= chars.length <= 2000
// chars[i] is a lower-case English letter, upper-case 
...
public:
    int compress(vector<char>& chars) {
        ...
        if(count == 1){
            s.push_back(chars[charsLength -1]);
