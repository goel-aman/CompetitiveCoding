...
// You are given an integer array nums where the ith
...
// For example, a bag of 5 balls can become two new bags 
...
// Return the minimum possible penalty after performing 
// the operations.
...
// Output: 3
// Explanation: 
// - Divide the bag with 9 balls into two bags of sizes 
// 6 and 3. [9] -> [6,3].
// - Divide the bag with 6 balls into two bags of sizes 
// 3 and 3. [6,3] -> [3,3,3].
...
// sizes 4 and 4. [2,4,8,2] -> [2,4,4,4,2].
// - Divide the bag with 4 balls into two bags of
// sizes 2 and 2. [2,4,4,4,2] -> [2,2,2,4,4,2].
// - Divide the bag with 4 balls into two bags of 
// sizes 2 and 2. [2,2,2,4,4,2] -> [2,2,2,2,2,4,2].
// - Divide the bag with 4 balls into two bags of
//  sizes 2 and 2. [2,2,2,2,2,4,2] -> [2,2,2,2,2,2,2,2].
// The bag with the most number of balls has 2 balls,
//  so your penalty is 2 an you should return 2.
...
public:
    int minimumSize(vector<int>& nums, int maxOperations) {
        ...
        int totalBagsWeHave = maxOperations + numsLength;
        int ans = INT_MAX;
        int start = 1,end = INT_MAX - 1;
        // if(numsLength == )
        while(start <= end){
            int mid = (start + end)/2; // bagsSize
            int totalbags = 0;
