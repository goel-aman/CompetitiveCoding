...
//  s1, s2, ..., sk where k >= 109, and you want to check 
// one by one to see if t has its subsequence. In this 
...
class Solution {
    public boolean isSubsequence(String s, String t) {
        ...
        if(sLength == tLength && s.equals(t)){
            return true;
        }
        
        int firstIndex = 0,secondIndex = 0;
        while(firstIndex < sLength && secondIndex < tLength){
