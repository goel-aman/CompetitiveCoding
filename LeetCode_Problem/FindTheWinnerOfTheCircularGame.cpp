...
//  and moving clockwise from the nth friend brings you to 
// the 1st friend.
...
// 9) Friend 5 leaves the circle. Only friend 3 is left, so they are
//  the winner.
...
public:
    int findTheWinner(int n, int k) {
        ...
        int arraySize = n;
        while(arraySize > 1){
            int index = (prev + increment)%arraySize;
            prev = index;
