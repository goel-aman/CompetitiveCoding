...
// Since -91283472332 is less than the lower bound of the range [-231, 231 - 1], the final
//  result is clamped to -231 = -2147483648.
...
public:
    int myAtoi(string s) {
        ...
        for(int i=0;i<sLength;i++){
            ...
            if(gotDigit && s[i] == ' ' || (signCount >= 1 && s[i] == ' ')){
                break;
            }
            if(s[i] == '.'){
                break;
