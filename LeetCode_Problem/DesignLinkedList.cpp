...
// val and next. val is the value of the current node, and 
...
// element of the linked list. After the insertion, the new node will
...
public:
    ...
    void addAtTail(int val) {
        // cout<<"value of tail is : "<<tail->val<<endl;
