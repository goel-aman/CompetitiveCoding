...
// void push(int val) pushes an integer val onto 
...
// freqStack.pop();   // return 7, as 5 and 7 is the most 
// frequent, but 7 is closest to the top. The stack becomes [5,7,5,4].
...
class FreqStack {
    ...
    unordered_map<int,stack<int>> maxStack;
public:
    FreqStack() {
