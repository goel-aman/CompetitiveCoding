...
// immediately at time 1, and finishes at time 3, so the waiting time of the first customer is 3 - 1 = 2.
// 2) The second customer arrives at time 2, the chef takes his order and starts preparing it
//  at time 3, and finishes at time 8, so the waiting time of the second customer is 8 - 2 = 6.
// 3) The third customer arrives at time 4, the chef takes his order and starts preparing it at 
// time 8, and finishes at time 11, so the waiting time of the third customer is 11 - 4 = 7.
...
public:
    double averageWaitingTime(vector<vector<int>>& customers) {
        ...
        double value = (ans / (double) customersLength);
        return value;
    }
};