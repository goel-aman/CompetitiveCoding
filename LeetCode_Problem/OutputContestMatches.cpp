...
// 544. Outpu0t Contest Matches
// During the NBA playoffs, we always set the rather strong team to play
//  with the rather weak team, like make the rank 1 team play with the
...
//  rank (i.e., Rank 1 is the strongest team and Rank n is the weakest
//  team).
...
//  for partition. During the pairing process in each round, you always
//  need to follow the strategy of making the rather strong one pair with 
// the rather weak one.
...
// Output: "((1,4),(2,3))"
// Explanation:
// In the first round, we pair the team 1 and 4, the teams 2 and 3 together, as
