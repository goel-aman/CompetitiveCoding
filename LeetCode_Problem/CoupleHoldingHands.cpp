...
//  of swaps so that every couple is sitting side by side. A swap consists of choosing any two people,
...
// the first couple being (0, 1), the second couple being (2, 3), and so on with the last couple
//  being (2N-2, 2N-1).
