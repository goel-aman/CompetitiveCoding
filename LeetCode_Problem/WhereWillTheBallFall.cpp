...
// You have a 2-D grid of size m x n representing a box, and you
//  have n balls. The box is open on the top and bottom sides.
...
// corner to the bottom-right corner and is represented in the grid as 1.
// A board that redirects the ball to the left spans the top-right 
// corner to the bottom-left corner and is represented in the grid as -1.
// We drop one ball at the top of each column of the box. Each ball 
// can get stuck in the box or fall out of the bottom. A ball gets 
// stuck if it hits a "V" shaped pattern between two boards or if a 
