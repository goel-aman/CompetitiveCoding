...
// ProductOfNumbers() Initializes the object with an empty
//  stream.
// void add(int num) Appends the integer num to the stream.
// int getProduct(int k) Returns the product of the last k numbers 
// in the current list. You can assume that always the current 
// list has at least k numbers.
// The test cases are generated so that, at any time, the product of
//  any contiguous sequence of numbers will fit into a single 32-bit
...
// productOfNumbers.getProduct(4); // return 0. The product of the 
// last 4 numbers is 0 * 2 * 5 * 4 = 0
