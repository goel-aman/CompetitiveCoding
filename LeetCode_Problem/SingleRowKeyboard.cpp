...
// finger is at index 0. To type a character, you have to move
//  your finger to the index of the desired character. The time
...
public:
    int calculateTime(string keyboard, string word) {
        ...
        for(int i=0;i<wordLength;i++){
            difference += abs(position[word[i]] - initialPosition);
            initialPosition = position[word[i]];
        }
