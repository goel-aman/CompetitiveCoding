...
//  if present. Returns true if the item was present, 
// false otherwise.
...
// randomizedSet.getRandom(); // getRandom() should return 
// either 1 or 2 randomly.
...
public:
    ...
    int getRandom() {
        int randElement = rand() % nums.size();
        return nums[randElement];
    }
};
