...
// The Dota2 senate consists of senators coming from 
// two parties. Now the Senate wants to decide on a 
// change in the Dota2 game. The voting for this change
//  is a round-based procedure. In each round, each senator
...
// of voting. All the senators who have lost their rights will be skipped
...
public:
    string predictPartyVictory(string senate) {
        ...
        while(!r.empty() && !d.empty()){
            ...
            r.pop();d.pop();
            (rIndex < dIndex) ?  r.push(rIndex + senateLength): d.push(dIndex + senateLength);
        }
