...
// If 5 was chosen as the pivot, 5 and 2 would be removed. In the next loop, 
// the sequence would have only -1 and the function would return true.
// If 2 was chosen as the pivot, 2 would be removed. In the next loop, the 
// sequence would have -1 and 5. No matter which number was chosen as the next
//  pivot, the function would find -1 and return true.
...
// If 5 was chosen as the pivot, 5 and 2 would be removed. In the next loop,
//  the sequence would have only -1 and the function would return false.
